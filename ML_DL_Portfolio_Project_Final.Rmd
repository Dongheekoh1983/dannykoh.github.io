...
<ul style = "color:#7BB6B3; font-size:20px">
  ...
  <li><a href="#interpretation" style = "color: #7BB6B3">Interpreting Machine Learning Models</a></li>
  <li><a href="#dnn" style = "color: #7BB6B3">Deep Neural Network(DNN) for Housing Price Prediction</a></li>
  <li><a href="#ml_dl" style = "color: #7BB6B3"> Performance Comparison between Machine Learning and Deep Neural Network</a></li>
  <li><a href="#boston_ml" style = "color: #7BB6B3">Implementing the Same ML Methods on Boston Housing Dataset</a></li>
  <li><a href="#boston_dnn" style = "color: #7BB6B3">Implementing the Same DNN Method on Boston Housing Dataset</a></li>
...
<p style = "color:#082C6F; font-size: 20px;text-indent: 25px">Paragraph about dataset description - Ames Housing Dataset and Boston Housing Dataset</p> 
...
digraph surveillance_diagram {    # 'digraph' means 'directional graph', then the graph name 
  ...
  training_set [label = '70%\n training nset', shape = rect,fontcolor='#3caea3' color='#3caea3']
...
<br>
<p style = "color:#082C6F; font-size: 20px">Before developing statistical models, the original dataset needed to be pre-processed by employing the following steps:</p> 
...
<p style = "color:#082C6F; font-size: 20px">brief outlining of this section- simply state how things are organized</p> 
...
<p style = "color:#082C6F; font-size: 20px;text-indent: 25px">The table below displays the resulting mean and standard deviation of pre-processed training dataset. As can be seen, all the numeric variables has mean of 0 and standard deviation of 1.</p> 
...
<p style = "color:#082C6F; font-size: 20px;text-indent: 25px">Machine Learning algorithms cannot use categorical variables directly as input. Instead, all data must be presented in a numerical format that machines can properly understand and process them. One-hot encoding is one of the most commonly used methods to achieve this. The following code demonstrates how I applied this technique to convert all my categorical variables into binary vectors, and the accompanying results below show that all variables have been processed as intended.</p> 
...
<p style = "color:#082C6F; font-size: 20px;text-indent: 25px">Explanation about EDA</p> 
...
knitr::include_graphics("/Users/dongheekoh/Documents/Data Science Training/portfolio/projects/stat577_ML_project/machine_learning_project/images/ames_neighborhoods.png")
```
...
knitr::include_graphics("/Users/dongheekoh/Documents/Data Science Training/portfolio/projects/stat577_ML_project/machine_learning_project/images/ames_saleprice.png")
```
...
```{r, echo=FALSE, out.width="75%", fig.align='center'}
knitr::include_graphics("/Users/dongheekoh/Documents/Data Science Training/portfolio/projects/stat577_ML_project/machine_learning_project/images/ames_price_lotsize_scatter.png")
```
...
```{r, echo=FALSE, out.width="75%", fig.align='center'}
knitr::include_graphics("/Users/dongheekoh/Documents/Data Science Training/portfolio/projects/stat577_ML_project/machine_learning_project/images/ames_price_liv_area_figure.png")
```
...
knitr::include_graphics("/Users/dongheekoh/Documents/Data Science Training/portfolio/projects/stat577_ML_project/machine_learning_project/images/ames_price_yearbuilt_eda.png")
```

### <span><a id="#" style="color: #7BB6B3;">5. Overall_Quality vs. Sale_price </a></span>
```{r, echo=TRUE, eval=FALSE}
...
```{r, echo=FALSE, out.width="100%", fig.align='center'}
knitr::include_graphics("/Users/dongheekoh/Documents/Data Science Training/portfolio/projects/stat577_ML_project/machine_learning_project/images/ames_price_condition_figure.png")
```

### <span><a id="#" style="color: #7BB6B3;">6. External Condition vs. Sale_price </a></span>
```{r, echo=TRUE, eval=FALSE}
...
```{r, echo=FALSE, out.width="100%", fig.align='center'}
knitr::include_graphics("/Users/dongheekoh/Documents/Data Science Training/portfolio/projects/stat577_ML_project/machine_learning_project/images/ames_price_ext_quality_figure.png")
```
...
<p style = "color:#082C6F; font-size: 20px;text-indent: 25px">Explanation about Performance Comparison of Machine Learning(ML) Models for Housing Price Prediction</p> 
```{r,echo=TRUE, eval=FALSE ,fig.align='center'}
n = nrow(ames)
rep = 15
...
## <span><a id="interpretation" style="color: #7BB6B3; text-transform: uppercase">Interpreting Machine Learning Models</a></span>
<p style = "color:#082C6F; font-size: 20px;text-indent: 25px">Explanation about Interpreting Machine Learning Models </p> 
```{r,echo=TRUE, eval=FALSE ,fig.align='center'}


```

## <span><a id="dnn" style="color: #7BB6B3; text-transform: uppercase">Deep Neural Network(DNN) for Housing Price Prediction</a></span>
<p style = "color:#082C6F; font-size: 20px;text-indent: 25px">Explanation about Deep Neural Network(DNN) for Housing Price Prediction</p> 
```{r,echo=TRUE, eval=FALSE ,fig.align='center'}
...
## <span><a id="ml_dl" style="color: #7BB6B3; text-transform: uppercase">Performance Comparison between Machine Learning and Deep Neural Network</a></span>
<p style = "color:#082C6F; font-size: 20px;text-indent: 25px">Explanation about Performance Comparison between Machine Learning and Deep Neural Network </p> 
```{r,echo=TRUE, eval=FALSE ,fig.align='center'}
...
## <span><a id="boston_ml" style="color: #7BB6B3; text-transform: uppercase">Implementing the Same ML Methods on Boston Housing Dataset</a></span>
<p style = "color:#082C6F; font-size: 20px;text-indent: 25px">Explanation about Implementing the Same Methods on Boston Housing Dataset</p> 
```{r,echo=TRUE, eval=FALSE ,fig.align='center'}
boston <- Boston
str(Boston)
dim(boston)
...
## <span><a id="boston_dnn" style="color: #7BB6B3; text-transform: uppercase">Implementing the Same DNN Method on Boston Housing Dataset</a></span>
<p style = "color:#082C6F; font-size: 20px;text-indent: 25px">Explanation about Deep Neural Network  </p> 
...
<p style = "color:#082C6F; font-size: 20px; text-indent: 25px">Project Summary and Discussion</p>
<br>
