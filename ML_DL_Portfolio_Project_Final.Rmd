...
<p style = "color:#082C6F; font-size: 20px">The model was trained for up to 2000 epoch, and the average MAE per epoch was plotted. As the plot indicated, the lowest MAE occured around epoch 950.</p>

### <span><a id="#" style="color: #7BB6B3;">7. Final Training and Testing</a></span>
<p style = "color:#082C6F; font-size: 20px">The final model was retrained on the full training dataset using the optimal epoch count (950), and then evaluated on the test set.</p>
...
<p style = "color:#082C6F; font-size: 20px;text-indent: 25px">to keep it simple, the code was removed because of similarity.</p> 
